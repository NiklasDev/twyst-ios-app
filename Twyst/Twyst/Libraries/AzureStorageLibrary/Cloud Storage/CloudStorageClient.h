...
@interface CloudStorageClient : NSObject <CloudURLRequestDelegate>
{
...
/*! Returns the binary data (NSData) object for the specified blob. By Yang*/
...
/*! Adds a new blob to a container, given the name of the blob, binary data for the blob, and content type. By Yang*/
...
@protocol CloudStorageClientDelegate <NSObject>
