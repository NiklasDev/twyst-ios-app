                                           ...
                                           parameters:(NSDictionary *)parameters
{
    ...
    return [self requestWithMethod:RKStringFromRequestMethod(method) path:[URL relativeString] headers:nil parameters:parameters];
}
                                ...
                                parameters:(NSDictionary *)parameters;
{
    ...
    return [self requestWithMethod:RKStringFromRequestMethod(method) path:requestPath headers:headers parameters:requestParameters];
}
                                       ...
                                       parameters:(NSDictionary *)parameters
{
    ...
    NSURLRequest *request = [self requestWithObject:object method:method path:path headers:headers parameters:parameters];
                                ...
                                failure:(void (^)(RKObjectRequestOperation *operation, NSError *error))failure
{
    ...
    RKObjectRequestOperation *operation = [self appropriateObjectRequestOperationWithObject:nil method:RKRequestMethodGET path:[URL relativeString] headers:nil parameters:parameters];
                 ...
                 failure:(void (^)(RKObjectRequestOperation *operation, NSError *error))failure
{
    ...
    RKObjectRequestOperation *operation = [self appropriateObjectRequestOperationWithObject:nil method:RKRequestMethodGET path:path headers:nil parameters:parameters];
    [operation setCompletionBlockWithSuccess:success failure:failure];
    [self enqueueObjectRequestOperation:operation];
}
          ...
          failure:(void (^)(RKObjectRequestOperation *operation, NSError *error))failure
{
    ...
    RKObjectRequestOperation *operation = [self appropriateObjectRequestOperationWithObject:object method:RKRequestMethodGET path:path headers:nil parameters:parameters];
    [operation setCompletionBlockWithSuccess:success failure:failure];
    [self enqueueObjectRequestOperation:operation];
}
...
- (void)postObject:(id)object
        ...
        parameters:(NSDictionary *)parameters
           ...
           failure:(void (^)(RKObjectRequestOperation *operation, NSError *error))failure {
    NSAssert(object || path, @"Cannot make a request without an object or a path.");
    RKObjectRequestOperation *operation = [self appropriateObjectRequestOperationWithObject:object method:RKRequestMethodPOST path:path headers:headers parameters:parameters];
    [operation setCompletionBlockWithSuccess:success failure:failure];
    [self enqueueObjectRequestOperation:operation];
}
...
{
    NSAssert(object || path, @"Cannot make a request without an object or a path.");
    RKObjectRequestOperation *operation = [self appropriateObjectRequestOperationWithObject:object method:RKRequestMethodPOST path:path headers:nil parameters:parameters];
    [operation setCompletionBlockWithSuccess:success failure:failure];
    [self enqueueObjectRequestOperation:operation];
}
...
{
    NSAssert(object || path, @"Cannot make a request without an object or a path.");
    RKObjectRequestOperation *operation = [self appropriateObjectRequestOperationWithObject:object method:RKRequestMethodPUT path:path headers:nil parameters:parameters];
    [operation setCompletionBlockWithSuccess:success failure:failure];
    [self enqueueObjectRequestOperation:operation];
}
...
{
    NSAssert(object || path, @"Cannot make a request without an object or a path.");
    RKObjectRequestOperation *operation = [self appropriateObjectRequestOperationWithObject:object method:RKRequestMethodPATCH path:path headers:nil parameters:parameters];
    [operation setCompletionBlockWithSuccess:success failure:failure];
    [self enqueueObjectRequestOperation:operation];
}
...
{
    NSAssert(object || path, @"Cannot make a request without an object or a path.");
    RKObjectRequestOperation *operation = [self appropriateObjectRequestOperationWithObject:object method:RKRequestMethodDELETE path:path headers:nil parameters:parameters];
    [operation setCompletionBlockWithSuccess:success failure:failure];
    [self enqueueObjectRequestOperation:operation];
}
...
- (RKPaginator *)paginatorWithPathPattern:(NSString *)pathPattern
{
    ...
    NSMutableURLRequest *request = [self requestWithMethod:@"GET" path:pathPattern headers:nil parameters:nil];
...
- (void)enqueueBatchOfObjectRequestOperationsWithRoute:(RKRoute *)route
    ...
    for (id object in objects) {
        ...
        if ([route isClassRoute]) {
            operation = [self appropriateObjectRequestOperationWithObject:object method:route.method path:[URL relativeString] headers:nil parameters:nil];
        } else {
            operation = [self appropriateObjectRequestOperationWithObject:nil method:route.method path:[URL relativeString] headers:nil parameters:nil];
        }
